...
\begin{figure}[t]
  ...
  \infrule[]{
    ...
    \langle H, R, E[x] \rangle \ra_D \langle H, R(x'), E[x'/x]\rangle
  }
  \infrule[]{
  }{
    \langle H, R, E[\LET x=y \IN e] \rangle \ra_D \langle H, R(x'\ra R(y)), E[[x'/x]e]\rangle
  }
  \infrule[]{
  }{
    \langle H, R, E[\LET x=n \IN e] \rangle \ra_D \langle H, R(x'\ra n), E[[x'/x]e]\rangle
  }
  \infrule[]{
  }{
    \langle H, R(x\ra 0), E[\IFZERO x\THEN e_1 \ELSE e_2] \rangle \ra_D \langle H, R(x\ra 0), E[e_1]\rangle
  }
  \infrule[]{R(x\neq 0)
  }{
  ...
  \infrule[]{y\notin dom(H)
    ...
    \langle H, R, E[\LET x=\MKREF y \IN e] \rangle \ra_D \langle H(y\ra v), R(x'\ra y), E[[x'/x]e]\rangle
  }
  \infrule[]{
  }{
    \langle H, R, E[\LET x=*y \IN e] \rangle \ra_D \langle H, R(x'\ra H(R(y))), E[[x'/x]e]\rangle
  }
  \infrule[]{f^l(\tilde{x})=e\in P
  }{
    \langle H, R, E[\LET x=f^l(\tilde{e}) \IN e] \rangle \ra_D \langle H, R, E[[\tilde{e}/\tilde{x}]e]\rangle
  }
  \infrule[]{
  }{
