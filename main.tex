...
In order to derive example for Context-Sensitiveness, we first focus on examples for function. Here are examples for “push/pull/goto” instructions.
We can see that function $\bf{push}$ is just assign an integer $x$ to variable $p$. $\bf{pull}$ is to pop the integer stored in $p$.
...
\newline
\newline
  $\bf{push} \COL \emptyset \ra \set{r \COL \TINT \mid r = x} \TREF^1$ \newline
  $\emptyset$ \newline
  $p \COL \set{r \COL \TINT \mid r = x} \TREF^1$
}
\colplacechunks
\end{parcolumns}
...
\newline
\newline
  $\bf{pull} \COL \set{r \COL \TINT \mid r = x} \TREF^1 \ra \emptyset$ \newline
  $p \COL \set{r \COL \TINT \mid r = x} \TREF^1$ \newline
  $\emptyset$
}
\colplacechunks
...
\newline
\newline
  $\bf{goto} \COL$ type changes in the statement.
}
\colplacechunks
\end{parcolumns}
...
\newline
\newline
  $\bf{push} \COL \emptyset \ra p \COL \set{r \COL \TINT \mid r = 0} \TREF^1$ \newline
  $\bf{goto} \COL$ type changes in $l_1$ and $l_2$. \newline \newline
  $l_1 \COL x \COL \emptyset \ra \set{r \COL \TINT \mid r = 0}, p \COL \set{r \COL \TINT \mid r = 0} \TREF^1\ra \emptyset$ \newline
  $\bf{push} \COL \emptyset \ra p \COL \set{r \COL \TINT \mid r = 1} \TREF^1$ \newline
  $\bf{goto} \COL$ type changes in $l_3$. \newline \newline
  $l_2 \COL x \COL \emptyset \ra \set{r \COL \TINT \mid r = 0}, p \COL \set{r \COL \TINT \mid r = 0} \TREF^1\ra \emptyset$ \newline
  $\bf{push} \COL \emptyset \ra p \COL \set{r \COL \TINT \mid r = 2} \TREF^1$ \newline
  $\bf{goto} \COL$ type changes in $l_3$. \newline \newline
  $l_3 \COL x \COL \emptyset \ra \set{r \COL \TINT \mid r = 1}, p \COL \set{r \COL \TINT \mid r = 1} \TREF^1\ra \emptyset$ \newline
  or $l_3 \COL x \COL \emptyset \ra \set{r \COL \TINT \mid r = 2}, p \COL \set{r \COL \TINT \mid r = 2} \TREF^1\ra \emptyset$ \newline
}
\colplacechunks
\end{parcolumns}
...
\begin{figure}[t]
  ...
  \infrule[]{
   ...
   \langle H, R, \overrightarrow{E}:E, v \rangle \ra_D \langle H, R, \overrightarrow{E}, E[v]\rangle
  }
  \infrule[]{
  }{
