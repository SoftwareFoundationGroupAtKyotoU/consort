...
\begin{figure}[t]
  ...
  \infrule[T-Seq]{
    \funenv \mid \tenv \mid \beta \vdash \expr_1 \COL \typ' \produces \tenv' \andalso
    \funenv \mid \tenv' \mid \beta \vdash \expr_2 \COL \typ'' \produces \tenv''
  }{
    \funenv \mid \tenv \mid \beta \vdash \expr_1; \expr_2 \COL \typ'' \produces \tenv''
  }
  \infrule[T-Assert]{
...
\begin{figure}[t]
  ...
  \infrule[]{
   ...
   \langle H, R, E:\overrightarrow{E}, x \rangle \ra_D \langle H, R, \overrightarrow{E}, E[x]\rangle
   }
   \infrule[]{
   }{
     \langle H, R, E:\overrightarrow{E}, E[x;e] \rangle \ra_D \langle H, R, \overrightarrow{E}, E[e]\rangle
  }
  \infrule[]{
    x' \notin \DOM(R)
  }{
  ...
  \infrule[]{H, R\models \phi
    ...
    \langle H, R, \overrightarrow{E}, E[\ASSERT(\phi); e] \rangle \ra_D \langle H, R, \overrightarrow{E}, E[e]\rangle
  }
  \infrule[]{H, R\not\models \phi
  }{
    \langle H, R, \overrightarrow{E}, E[\ASSERT(\phi); e] \rangle \ra_D \bf{AssertFail}
  }
