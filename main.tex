...
\begin{figure}[t]
  ...
  \infrule[]{
    ...
    \langle H, R, E[x] \rangle \ra_D \langle H, R, E[R(x)]\rangle
  }
  \infrule[]{
    x' \notin \DOM(R)
  }{
    \langle H, R, E[\LET x=y \IN e] \rangle \ra_D \langle H, R \EXTEND{x' \mapsto R(y)}, E[[x'/x]e]\rangle
  }
  \infrule[]{
    x' \notin \DOM(R)    
  }{
    \langle H, R, E[\LET x=n \IN e] \rangle \ra_D \langle H, R \EXTEND{x' \mapsto n}, E[[x'/x]e]\rangle
  }
  \infrule[]{
    R(x) = 0
  }{
    \langle H, R, E[\IFZERO x\THEN e_1 \ELSE e_2] \rangle \ra_D \langle H, R, E[e_1]\rangle
  }
  \infrule[]{
    R(x) \neq 0
  }{
    \langle H, R, E[\IFZERO x\THEN e_1 \ELSE e_2] \rangle \ra_D \langle H, R, E[e_2]\rangle
  }
  \infrule[]{
    a \notin \DOM(H) \andalso x' \notin \DOM(R)
  }{
    \langle H, R, E[\LET x=\MKREF y \IN e] \rangle \ra_D \langle H \EXTEND{a \mapsto v}, R \EXTEND{x' \mapsto y}, E[[x'/x]e]\rangle
  }
  \infrule[]{
    R(y) = a \andalso H(a) = v \andalso x' \notin \DOM(R)
  }{
    \langle H, R, E[\LET x=*y \IN e] \rangle \ra_D \langle H, R\EXTEND{x' \mapsto v}, E[[x'/x]e]\rangle
  }
  \infrule[]{f^l(\tilde{x})=e\in P
  }{
    \langle H, R, E[\LET x=f^l(\tilde{y}) \IN e'] \rangle \ra_D \langle H, R, E[[\tilde{y}/\tilde{x}]e]\rangle
  }
  \infrule[]{
  }{
    \langle H, R, E[x:=y; e] \rangle \ra_D \langle H, R(x'\ra y), E[[x'/x]e]\rangle
  }
  \infrule[]{H, R\models (e_1=e_2)
  }{
    \langle H, R, E[\ALIAS(e_1=e_2); e_3] \rangle \ra_D \langle H, R, E[e_3]\rangle
  }
  \infrule[]{H, R\not\models (e_1=e_2)
  }{
    \langle H, R, E[\ALIAS(e_1=e_2); e_3] \rangle \ra_D \bf{AliasFail}
  }
  \infrule[]{H, R\models \phi
  }{
    \langle H, R, E[\ASSERT(\phi)] \rangle \ra_D \langle H, R, E\rangle
  }
  \infrule[]{H, R\not\models \phi
  }{
    \langle H, R, E[\ASSERT(\phi)] \rangle \ra_D \bf{AssertFail}
  }
