let () =
  ...
  | Some in_name -> 
    let res = VerifyUtil.check_file ~print_cons:!show_cons ~print_pred:!show_pred ~print_ast:!show_ast ~get_model:!show_model ?intrinsic_defn:!intrinsic_file in_name in
